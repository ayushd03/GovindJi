    ...
    <div className="page-container py-12 md:py-16">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-foreground">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold">2. Collection of Information</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold">3. Usage of Information</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold">5. Security Precautions</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold">6. Data Deletion and Retention</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold">7. Your Rights and Consent</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold">9. Grievance Officer & Contact Us</h2>
