            ...
            <div className="p-6 space-y-6">
                ...
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">{formatCurrency(analytics.todayTotal || 0)}</p>
                    </div>
                ...
                <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">{formatCurrency(analytics.weekTotal || 0)}</p>
                    </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">This Month's Expenses by Category</h3>
                ...
                {/* Daily Trend Chart */}
                <div className="bg-gray-50 rounded-xl p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Daily Expense Trend (Last 7 Days)</h3>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                {expenses.slice(0, 5).map((expense) => {
                  ...
                  return (
                    <div key={expense.id} className="flex items-center justify-between py-3 border-b border-gray-200 last:border-b-0">
                              ...
                              <div className="flex items-center space-x-4">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="mt-1 flex items-center space-x-4 text-sm text-gray-500 flex-wrap">
                                    ...
                                    {(expense.vendor_name || expense.employee_name) && (
                                      <span>• {expense.vendor_name || expense.employee_name}</span>
                                    )}
                                  </div>
                                </div>
                              </div>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    required
                    className="w-full px-4 py-3 text-xl border-2 border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500"
